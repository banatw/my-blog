...
<body>
    ...
    <script src="../blog-assets/js/jqBootstrapValidation.js"></script>
    <script src="../blog-assets/js/contact_me.js"></script>

    <!-- Theme JavaScript -->
    <script src="../blog-assets/js/clean-blog.min.js"></script>
